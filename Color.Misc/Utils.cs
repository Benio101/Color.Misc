...
namespace Color.Misc
{
	...
	{
		internal const string IdentifierCharacterRanges
		...
		internal const string IdentifierCharacter = @"["  + IdentifierCharacterRanges + @"]";
		internal const string IdentifierBeginningBoundary = @"(?<!" + IdentifierCharacter + ")";
		internal const string IdentifierEndingBoundary = @"(?!" + IdentifierCharacter + ")";
		internal const string Identifier = IdentifierBeginningBoundary + IdentifierCharacter + @"+" + IdentifierEndingBoundary;

		//// Characters of @Identifier that can be on every place (even on first character).
		//internal const string IdentifierCommonCharacters
		...
		//		// Prevent matching identifier's beginning inside another identifier.
